...
export interface DbRepository {
  ...
  getModelParameter(workspaceId: string, modelId: string): Promise<ModelParameterRecord | null>;
  ...
  updateMcpServerOAuthState(id: string, oauthState: Record<string, unknown>): Promise<void>;
  ...
  listNyxelEventsByWorkspace(workspaceId: string, limit?: number): Promise<NyxelEventRecord[]>;
  ...
  getExtensionByKey(workspaceId: string, key: string): Promise<ExtensionRecord | null>;
  setExtensionEnabled(id: string, enabled: boolean): Promise<ExtensionRecord>;
  updateExtensionConfig(id: string, config: Record<string, unknown>): Promise<ExtensionRecord>;
  ...
  createWorkflowRun(input: { workflowId: string; workspaceId: string }): Promise<WorkflowRunRecord>;
  ...
  createWorkflowRunNode(input: { runId: string; nodeId: string }): Promise<WorkflowRunNodeRecord>;
  ...
  /** Most recent first. */
  listSeoAnalysisRunsByProject(seoProjectId: string): Promise<SeoAnalysisRunRecord[]>;
  ...
  listOpenSeoFindingsByProject(seoProjectId: string): Promise<SeoFindingRecord[]>;
  ...
  listSeoBlogPostsByProject(seoProjectId: string): Promise<SeoBlogPostRecord[]>;
