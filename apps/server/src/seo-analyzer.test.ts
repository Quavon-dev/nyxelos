...
let testDb: Awaited<ReturnType<typeof installTestDb>>;

beforeEach(async () => {
  testDb = await installTestDb();
});
      ...
      agentDefs: [
        {
          ...
          description: "Audits technical SEO issues",
          body: "...",
        },
        {
          slug: "schema-specialist",
          name: "Schema Specialist",
          description: "Structured data / schema.org expert",
          body: "...",
        },
        {
          slug: "copywriter",
          name: "General Copywriter",
...
describe("pickRelevantPluginSkills", () => {
  const installDir =
    "/tmp/claude-0/-home-user-nyxelos/0ba69a41-21e5-57c5-b733-bc66b97b7bdb/scratchpad/seo-plugin-test";
