		...
		<Popover>
			...
			<PopoverContent align="start" className="w-80">
				...
				<p className="-mt-2 text-xs text-muted-foreground">
					By default a chat can use every skill and MCP server in this
					workspace. Narrow it down here if this conversation should only reach
					a subset.
				</p>
									...
									<div className="flex items-center gap-2">
										...
										{checked && (
											<button
												...
												aria-label={
													expanded ? "Hide tools" : "Choose individual tools"
												}
											>
												{expanded ? (
